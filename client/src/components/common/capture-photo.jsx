    ...
    <div className="absolute h-5/6 w-2/6 top-20 left-1/3 bg-gray-900 rounded-lg flex items-center justify-center">
      <div className="flex flex-col gap-2 w-full">
        <div className="pt-2 pr-2 cursor-pointer flex items-start justify-end">
          <IoClose className="h-10 w-10 text-white " onClick={() => hide(false)} />
        </div>
        ...
        <button
          className="h-16 w-16 bg-white rounded-full cursor-pointer border-8 border-teal-light p-2 mb-10 self-center"
          onClick={capturePhoto}
        ></button>
      </div>
    </div>
