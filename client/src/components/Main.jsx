...
function Main() {
  ...
  useEffect(() => {
    console.log("hell of from socket user");

    if (userInfo) {
      socket.current = io(HOST);
      socket.current.emit("add-user", userInfo.id);
      console.log("hello", socket.current);
  ...
  useEffect(() => {
    console.log("received useEffect", socket.current, socketEvent);
  ...
  useEffect(() => {
    const getMessages = async () => {
      ...
      console.log("allm esss", messages);
    };
  ...
  console.log('video call is there', videoCall);
  console.log('voice call is there', voiceCall);
